...
const Neurology = () => {
  ...
  const handleBookConsultation = async () => {
    setLoading(true);
    try {
      // Update the payment link to match neuro consultation
      const paymentUrl = await createPaymentLink(1200, "Neuro Consultation");
      if (paymentUrl) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.fixedTitleAndToggle}>
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Neuro Consultation</Text>
        </View>
        ...
        {activeSection === "details" && (
          <View style={styles.section}>
            <Text style={styles.description}>
              Neuro consultations involve diagnosing and treating neurological
              disorders such as headaches, migraines, memory loss, and more. Our
              specialists provide accurate assessments and personalized
              treatment plans.
            </Text>
            ...
            <View style={styles.expectations}>
              <View style={styles.expectation}>
                ...
                <Text style={styles.expectationText}>45 mins consultation</Text>
              </View>
              <View style={styles.expectation}>
